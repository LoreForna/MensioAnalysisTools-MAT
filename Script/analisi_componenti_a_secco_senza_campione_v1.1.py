"""
SCRIPT ANALISI QUANTITATIVA COMPONENTI A SECCO SENZA AREA CAMPIONE - VERSIONE 1.1
...
# ============ CLASSE PRINCIPALE ============
class AnalisiComponentiASeccoSenzaCampione(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        feedback.pushInfo("\n" + "="*70)
        feedback.pushInfo("ANALISI QUANTITATIVA COMPONENTI A SECCO SENZA AREA CAMPIONE - v1.1")
...
END'''
    ...
    def name(self) -> str:
        return 'analisi_componenti_a_secco_senza_campione'

    def displayName(self) -> str:
        return 'Componenti a secco senza campione'
    ...
    def createInstance(self):
        return AnalisiComponentiASeccoSenzaCampione()

    def shortHelpString(self) -> str:
        return """
        <h3>Analisi Quantitativa Componenti a Secco Senza Area Campione - Versione 1.1</h3>
        
        <p>Analizza le geometrie dei componenti a secco in una muratura senza necessità del layer campioni.
