"""
SCRIPT ANALISI QUANTITATIVA MATTONI SENZA AREA CAMPIONE - VERSIONE 1.1
...
class AnalisiSenzaCampione(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        feedback.pushInfo("\n" + "="*70)
        feedback.pushInfo("ANALISI QUANTITATIVA MATTONI SENZA AREA CAMPIONE - v1.1")
...
END'''
    ...
    def shortHelpString(self) -> str:
        return """
        <h3>Analisi Quantitativa Mattoni Senza Area Campione - Versione 1.1</h3>
